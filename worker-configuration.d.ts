/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd0420cde740f80b30847b590f139da8)
...
interface __BaseEnv_Env {
	...
	GOOGLE_CREDS_SA_EMAIL: SecretsStoreSecret;
	...
	GMAIL_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").GmailAgent>;
	DOCS_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").DocsAgent>;
	SHEETS_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").SheetsAgent>;
	SLIDES_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").SlidesAgent>;
	APPSSCRIPT_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").AppsScriptAgent>;
	...
	CIRCUIT_BREAKER: DurableObjectNamespace /* CircuitBreaker */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INBOX_FORWARD_TO" | "GOOGLE_OAUTH_REDIRECT_URI" | "GOOGLE_USER_TO_IMPERSONATE" | "GOOGLE_WORKSPACE_ACCOUNT_EMAIL" | "GOOGLE_PERSONAL_ACCOUNT_EMAIL" | "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "DEFAULT_MODEL_EMBEDDING" | "CIRCUIT_MAX_REQ_PER_MIN" | "CIRCUIT_MAX_AGENT_PER_MIN" | "CIRCUIT_MAX_AI_PER_MIN" | "CIRCUIT_MAX_TOOL_PER_MIN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "PUBLIC_BASE_URL">> {}
}
