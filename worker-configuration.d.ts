/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef0cb7c9874e51a3aeaca5a47f65f11d)
...
interface __BaseEnv_Env {
	...
	GMAIL_AGENT: DurableObjectNamespace /* GmailAgent */;
	DOCS_AGENT: DurableObjectNamespace /* DocsAgent */;
	SHEETS_AGENT: DurableObjectNamespace /* SheetsAgent */;
	SLIDES_AGENT: DurableObjectNamespace /* SlidesAgent */;
	APPSSCRIPT_AGENT: DurableObjectNamespace /* AppsScriptAgent */;
	DRIVE_AGENT: DurableObjectNamespace /* DriveAgent */;
	CALENDAR_AGENT: DurableObjectNamespace /* CalendarAgent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker.js/index");
		durableNamespaces: "OrchestratorAgent" | "GmailAgent" | "DocsAgent" | "SheetsAgent" | "SlidesAgent" | "AppsScriptAgent" | "DriveAgent" | "CalendarAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INBOX_FORWARD_TO" | "GOOGLE_OAUTH_REDIRECT_URI" | "GOOGLE_USER_TO_IMPERSONATE" | "GOOGLE_WORKSPACE_ACCOUNT_EMAIL" | "GOOGLE_PERSONAL_ACCOUNT_EMAIL" | "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "DEFAULT_MODEL_EMBEDDING" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "PUBLIC_BASE_URL">> {}
}
